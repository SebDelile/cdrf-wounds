export const EXPLANATION = {
  intro:
    "Lorsqu'un combattant est touché par un projectile, une attaque au corps à corps ou tout autre effet à vocation offensive, la gravité des dégâts qu'il subit est déterminée par un jet de Blessures.",
  rule: "Lors d'un tel jet, le joueur à l'origine de l'agression lance 2 dés et consulte le Tableau des Blessures ci-dessous. Chaque dé est lu indépendamment :",
  smallerDice:
